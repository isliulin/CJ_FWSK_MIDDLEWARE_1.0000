...
//构造函数
//-------------------------------------------------------------------------------------------
CSKJQljsjgqr::CSKJQljsjgqr(CYWXML_GY &ywxml_gy, string Qtxx):m_Qtxx(Qtxx), CSKJYWXmlBase(ywxml_gy)
{
	m_FpCount = 1;
	m_Count = 1;
}
...
//析构函数
//-------------------------------------------------------------------------------------------
CSKJQljsjgqr::~CSKJQljsjgqr()
{

}


INT32 CSKJQljsjgqr::XmlBuild()
{
	UINT8 i = 0;
	INT8 Buf[64];
