...
INT32 CFpbl::Execute()
{
	UINT32 StartDate = 0;		//报税开始日期
	UINT32 EndDate = 0;			//报税截止日期
	Return_Info retInfo;//返回信息
	INT32 retcode = 0;
	INT8 tmpbuf[64];
	
	XmlParse(m_pXmlParse, StartDate, EndDate);	//调用XML解析函数
