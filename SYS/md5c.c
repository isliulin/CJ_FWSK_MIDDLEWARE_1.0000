...
static void MD5Transform (UINT32 *, UINT8 *);
...
static MD5_CTX s_MD5_CTX;
extern MD5_CTX *g_MD5_CTX = &s_MD5_CTX;

/* MD5 initialization. Begins an MD5 operation, writing a new context.
 */
void MD5Init_skj (MD5_CTX *context)                                
{
 ...
 */
void MD5Update_skj (MD5_CTX *context, UINT8 *input, UINT32 inputLen)
{
 ...
 */
void MD5Final_skj (UINT8 digest[16], MD5_CTX *context)

{
	...
	MD5Update_skj (context, PADDING, padLen);

	/* Append length (before padding) */
	MD5Update_skj (context, bits, 8);
